#################################################################
# This script contains work-in-progress for further optimization
# to our algorithm.  Further documentation will come later.
# Based on a script by Miquel Torrens
#################################################################

################################################################################
massageTestSet <- function(train, test, verbose = TRUE) {
